...
Compared to the task assignment all the logic is extracted to [gradle/filesPlugin.gradle](gradle/filesPlugin.gradle.kts) file.
Only thing being done in the main [build.gradle](build.gradle.kts) script file is to apply local script plugin filesPlugin.
