...
logger.quiet("=============================================================================================")
logger.quiet("                         Pre-compiled Files Plugin                                           ")
logger.quiet("=============================================================================================")
...
fun getFileDirectoryMapper(sortType: String, logger: Logger): FileDirectoryMapper {
    return when (sortType) {
        ...
        "alphabet" -> FileDirectoryAlphabeticMapper()
        else -> {
...
class FileDirectoryAlphabeticMapper : FileDirectoryMapper {
    override fun getDirectory(file: File): String = file.name.first().toString()
}
